...
// 
    ...
    // };
// 
    // let res = await axios.post('http://localhost:8080/api/productos', prod);
// 
    // let data = res.data;
    // console.log(data);
// }
...
//         thumbnail: 'https://cdn2.iconfinder.com/data/icons/international-food/64/fried_rice-128.png'
//     };
//         const resp = await axios.put('http://localhost:8080/api/productos/610f6585f3ef9e415102f3c9'/*copiar ID segun producto de la DB*/, prod);
